    ...
    return (
      <div className="min-h-screen bg-parchment grid-background">
        ...
        <div className="max-w-4xl mx-auto px-4 py-12 text-center">
          <h2 className="font-serif text-2xl text-charcoal mb-4">Case Not Found</h2>
      ...
      <main className="max-w-5xl mx-auto px-4 py-12">
        ...
        <div className="mb-12 text-center relative">
          <p className="text-sage font-mono uppercase tracking-[0.2em] text-xs mb-4 animate-fade-in">
            Plan of Care &mdash; {recipe.category}
          </p>
            ...
            <div className="bg-paper border border-charcoal/10 rounded-sm p-6 shadow-[0_2px_8px_-2px_rgba(0,0,0,0.05)]">
              ...
              <div className="flex items-center gap-4">
                ...
                <span className="text-charcoal font-serif italic text-lg">
                  {getStabilityLabel(recipe.stabilityGrade)}
                </span>
              </div>
            </div>
        ...
        {/* Clinical Impression */}
        {recipe.clinicalImpression && recipe.clinicalImpression !== "Recipe details coming soon." && (
        ...
        <div className="grid md:grid-cols-12 gap-12">
          {/* Composition (Ingredients) - Sticky Sidebar */}
          <div className="md:col-span-4">
            <div className="sticky top-8">
              <h2 className="font-serif text-2xl text-charcoal mb-6 pb-2 border-b-2 border-charcoal/10 flex items-center justify-between">
                Composition
          ...
          <div className="md:col-span-8">
            <h2 className="font-serif text-2xl text-charcoal mb-8 pb-2 border-b-2 border-charcoal/10 flex items-center justify-between">
              The Protocol
              <span className="text-xs font-mono text-charcoal/40 font-normal tracking-widest uppercase">Instructions</span>
            </h2>
